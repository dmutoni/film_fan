...
class CreditsApiClient {
  CreditsApiClient({http.Client? client}) : _client = client ?? http.Client();
  ...
  Future<Credit> getActors(int id) async {
    final Map<String, String> queryParameters = {
      'api_key': 'f0760d61c4bc8ae2e06246d60622ae47',
      'language': 'en-US',
      'page': '1',
    };
    final uri = Uri.https(authority, '/3/movie/$id/credits', queryParameters);
    final responseBody = await _get(uri);
    try {
      return Credit.fromJson(responseBody);
    } catch (e) {
